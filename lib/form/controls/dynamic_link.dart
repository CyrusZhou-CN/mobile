...
import 'package:frappe_app/widgets/form_builder_typeahead.dart'
    show FormBuilderTypeAhead, ItemBuilder, SuggestionsCallback;
    ...
    return Theme(
      ...
      child: FormBuilderTypeAhead(
        ...
        decoration: Palette.formFieldDecoration(
          ...
          suffixIcon:
              widget.doc[widget.doctypeField.fieldname] != null &&
              ...
              ? IconButton(
                  ...
                  icon: FrappeIcon(FrappeIcons.arrow_right_2, size: 14),
                )
              : null,
        ),
        ...
        suggestionsCallback:
            ...
            (query) async {
              ...
              if (!isOnline) {
                ...
                if (linkFull != null) {
                  return linkFull["results"].where((link) {
                    return (link["value"] as String).toLowerCase().contains(
                      lowercaseQuery,
                    );
                  }).toList();
                } else {
