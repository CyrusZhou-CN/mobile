             ...
             builder: (context, snapshot) {
               if (snapshot.hasData) {
                 ...
                 tableFields.forEach((item) {
                   columns.add(
                     JsonTableColumn(item.fieldname, label: item.label),
                   );
                 ...
                 colCount = columns.length < colCount
                     ? columns.length
                     : colCount;
                 ...
                 return Column(
                   ...
                   children: [
                     JsonTable(
                       ...
                       //   var isNum =
                       //       double.tryParse(cellValue.toString()) != null;
                       //   return Container(
...
class TableElement extends StatefulWidget {
  ...
  TableElement({required this.meta, required this.doc, required this.fields});
